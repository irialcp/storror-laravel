...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const registrationStatusMessage = document.getElementById(
    ...
    if (registerForm) {
        registerForm.addEventListener("submit", async (event) => {
            ...
            if (registrationStatusMessage) {
                ...
                console.error(
                    "Errore: Elemento con ID 'registration-status-message' non trovato nel DOM."
                );
                return;
            }
            ...
            try {
                ...
                console.error(
                    "Errore durante la registrazione (catch generale):",
                    error
                );
                registrationStatusMessage.textContent =
